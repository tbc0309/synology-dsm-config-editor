# Synology DSM Configuration Editor — Simplified Chinese

[简体中文](README_zh-CN.md)

A dependency-free Shell CGI configuration editor for Synology DSM 7 packages. This branch uses a fixed Simplified Chinese interface.
